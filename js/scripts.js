			...
			if ($(this).hasClass("carouFredSel")) {
				...
				if (slider.siblings('.slider_prev').length) {
					...
					slider.slick({
						...
						prevArrow: '<a class="button button_js slider_prev" href="#"><span class="button_icon"><i class="fa fa-angle-left" style="font-size: 50px;"></i></span></a>',
						nextArrow: '<a class="button button_js slider_next" href="#"><span class="button_icon"><i class="fa fa-angle-right"></i></span></a>',
	...
	function mfnSliderTestimonials() {
		...
		$('.testimonials_slider_ul').each(function () {
			...
			slider.slick({
				...
				prevArrow: '<a class="button button_js slider_prev" href="#"><span class="button_icon"><i class="fa fa-angle-left"></i></span></a>',
				nextArrow: '<a class="button button_js slider_next" href="#"><span class="button_icon"><i class="fa fa-angle-right"></i></span></a>',
	...
	function mfnSliderPortfolio() {
		/*	$('.portfolio_slider_ul').each(function(){
					...
					slider.slick({
						...
						prevArrow		: '<a class="slider_nav slider_prev themebg" href="#"><i class="fa fa-angle-left"></i></a>',
						nextArrow		: '<a class="slider_nav slider_next themebg" href="#"><i class="fa fa-angle-right"></i></a>',
		...
		$('.portfolio_slider_ul').each(function () {
			...
			slider.slick({
				...
				prevArrow: '<a class="slider_nav slider_prev themebg" href="#"><i class="fa fa-angle-left" style="font-size: 50px;"></i></a>',
				nextArrow: '<a class="slider_nav slider_next themebg" href="#"><i class="fa fa-angle-right" style="font-size: 50px;"></i></a>',
